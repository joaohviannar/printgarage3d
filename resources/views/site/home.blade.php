...
{{-- ============================================
     PARCEIROS
     ============================================ --}}
@if(isset($parcerias) && $parcerias->isNotEmpty())
<section x-data="{ aberto: false, parceiro: {} }" class="py-20 bg-brand-dark-soft">
    <div class="container-x">
        <div class="text-center mb-14">
            <span class="badge bg-brand-red/10 text-brand-red-300 border border-brand-red-700/40 mb-4">🤝 Quem confia na gente</span>
            <h2 class="text-3xl lg:text-4xl font-bold">Nossos Parceiros</h2>
        </div>
